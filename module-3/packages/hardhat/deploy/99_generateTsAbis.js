...
const generateTsAbis = async function () {
    ...
    fs.writeFileSync(`${TARGET_DIR}deployedContracts.ts`, prettier_1.default.format(`${generatedContractComment} import { GenericContractsDeclaration } from "~~/utils/scaffold-eth/contract"; \n\n
