...
describe("Upgrade from Safe 1.1.1", function () {
    ...
    var setupTests = hardhat_1.deployments.createFixture(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var mock, singleton111, singleton140, factory, saltNonce, proxyAddress, Safe, safe, _c, nonce, data, tx, _d, _e, _f;
        var _g;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    mock = _h.sent();
                    return [4 /*yield*/, user1.sendTransaction({ data: safeDeployment_json_1.default.safe111 })];
                case 3: return [4 /*yield*/, (_h.sent()).wait()];
                case 4:
                    singleton111 = (_h.sent()).contractAddress;
                ...
                case 6:
                    factory = _h.sent();
                    saltNonce = 42;
                    return [4 /*yield*/, (0, proxies_1.calculateProxyAddress)(factory, singleton111, "0x", saltNonce)];
                case 7:
                    proxyAddress = _h.sent();
                    return [4 /*yield*/, factory.createProxyWithNonce(singleton111, "0x", saltNonce).then(function (tx) { return tx.wait(); })];
                case 8:
                    _h.sent();
                ...
                case 11:
                    _c.apply(void 0, [_h.sent()]).to.be.eq("1.1.1");
