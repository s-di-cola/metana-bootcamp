...
describe("HandlerContext", function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user1, user2, setup;
    return __generator(this, function (_b) {
        _a = hardhat_1.waffle.provider.getWallets(), user1 = _a[0], user2 = _a[1];
        setup = hardhat_1.deployments.createFixture(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.sent();
                        return [4 /*yield*/, hardhat_1.default.ethers.getContractFactory("TestHandler")];
                    case 2:
                        TestHandler = _d.sent();
                        return [4 /*yield*/, TestHandler.deploy()];
                    case 3:
                        handler = _d.sent();
                        _c = {};
        ...
        it("parses information correctly", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it("works with the Safe", function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, safe, handler, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, setup()];
                    case 1:
                        _a = _b.sent(), safe = _a.safe, handler = _a.handler;
