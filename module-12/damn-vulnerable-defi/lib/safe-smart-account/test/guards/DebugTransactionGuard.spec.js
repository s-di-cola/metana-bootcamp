...
describe("DebugTransactionGuard", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        setupTests = hardhat_1.deployments.createFixture(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        safe = _c.sent();
                        return [4 /*yield*/, hardhat_1.default.ethers.getContractFactory("DebugTransactionGuard")];
                    case 3:
                    ...
                    case 5:
                        mock = _c.sent();
                        return [4 /*yield*/, (0, execution_2.executeContractCallWithSigners)(safe, safe, "setGuard", [guard.address], [user1])];
                    case 6:
                        _c.sent();
                        return [2 /*return*/, {
                                safe: safe,
        ...
        describe("checkTransaction", function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                it("should emit debug events", function () { return __awaiter(void 0, void 0, void 0, function () {
                    var _a, safe, mock, guard, nonce, safeTx, safeTxHash, _b, _c, signature, _d, _e;
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0: return [4 /*yield*/, setupTests()];
                            case 1:
                                _a = _f.sent(), safe = _a.safe, mock = _a.mock, guard = _a.guard;
                                return [4 /*yield*/, safe.nonce()];
                            case 2:
                                nonce = _f.sent();
                                safeTx = (0, execution_2.buildSafeTransaction)({ to: mock.address, data: "0xbaddad42", nonce: nonce });
                                _b = execution_2.calculateSafeTransactionHash;
                                _c = [safe, safeTx];
                                return [4 /*yield*/, (0, encoding_1.chainId)()];
                            case 3:
                                safeTxHash = _b.apply(void 0, _c.concat([_f.sent()]));
                                return [4 /*yield*/, (0, execution_1.signHash)(user1, safeTxHash)];
                            case 4:
                                signature = _f.sent();
                                return [4 /*yield*/, (0, chai_1.expect)((0, execution_2.executeTx)(safe, safeTx, [signature]))
                            ...
                            case 6:
                                _d.apply(void 0, [_f.sent()]).to.be.eq(1);
                                _e = chai_1.expect;
