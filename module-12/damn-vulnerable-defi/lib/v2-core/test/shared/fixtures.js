...
exports.pairFixture = exports.factoryFixture = void 0;
...
function factoryFixture(_1, _a) {
    return __awaiter(this, arguments, void 0, function (_, _b) {
        var factory;
        var wallet = _b[0];
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(wallet, UniswapV2Factory_json_1.default, [wallet.address], overrides)];
                case 1:
                    factory = _c.sent();
...
function pairFixture(provider_1, _a) {
    return __awaiter(this, arguments, void 0, function (provider, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    factory = (_c.sent()).factory;
                    return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(wallet, ERC20_json_1.default, [(0, utilities_1.expandTo18Decimals)(10000)], overrides)];
                case 2:
                    tokenA = _c.sent();
                    return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(wallet, ERC20_json_1.default, [(0, utilities_1.expandTo18Decimals)(10000)], overrides)];
                case 3:
