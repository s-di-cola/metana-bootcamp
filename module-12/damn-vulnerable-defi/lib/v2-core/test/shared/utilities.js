...
exports.encodePrice = exports.mineBlock = exports.getApprovalDigest = exports.getCreate2Address = exports.expandTo18Decimals = void 0;
var utils_1 = require("ethers/utils");
var PERMIT_TYPEHASH = (0, utils_1.keccak256)((0, utils_1.toUtf8Bytes)('Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)'));
function expandTo18Decimals(n) {
    return (0, utils_1.bigNumberify)(n).mul((0, utils_1.bigNumberify)(10).pow(18));
}
...
function getCreate2Address(factoryAddress, _a, bytecode) {
    ...
    var create2Inputs = [
        '0xff',
        factoryAddress,
        (0, utils_1.keccak256)((0, utils_1.solidityPack)(['address', 'address'], [token0, token1])),
        (0, utils_1.keccak256)(bytecode)
    ];
    var sanitizedInputs = "0x".concat(create2Inputs.map(function (i) { return i.slice(2); }).join(''));
    return (0, utils_1.getAddress)("0x".concat((0, utils_1.keccak256)(sanitizedInputs).slice(-40)));
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (0, utils_1.keccak256)((0, utils_1.solidityPack)(['bytes1', 'bytes1', 'bytes32', 'bytes32'], [
                            '0x19',
                            '0x01',
                            DOMAIN_SEPARATOR,
...
function encodePrice(reserve0, reserve1) {
    return [reserve1.mul((0, utils_1.bigNumberify)(2).pow(112)).div(reserve0), reserve0.mul((0, utils_1.bigNumberify)(2).pow(112)).div(reserve1)];
}
