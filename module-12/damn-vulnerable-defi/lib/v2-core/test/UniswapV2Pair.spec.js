...
var MINIMUM_LIQUIDITY = (0, utils_1.bigNumberify)(10).pow(3);
...
describe('UniswapV2Pair', function () {
    ...
    it('mint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)(pair.mint(wallet.address, overrides))
                ...
                case 8:
                    reserves = _e.sent();
                    (0, chai_1.expect)(reserves[0]).to.eq(token0Amount);
                    (0, chai_1.expect)(reserves[1]).to.eq(token1Amount);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    ].map(function (a) { return a.map(function (n) { return (typeof n === 'string' ? (0, utils_1.bigNumberify)(n) : (0, utilities_1.expandTo18Decimals)(n)); }); });
    swapTestCases.forEach(function (swapTestCase, i) {
        it("getInputPrice:".concat(i), function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, chai_1.expect)(pair.swap(0, expectedOutputAmount.add(1), wallet.address, '0x', overrides)).to.be.revertedWith('UniswapV2: K')];
                    case 3:
                        _a.sent();
    ...
    optimisticTestCases.forEach(function (optimisticTestCase, i) {
        it("optimistic:".concat(i), function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, chai_1.expect)(pair.swap(outputAmount.add(1), 0, wallet.address, '0x', overrides)).to.be.revertedWith('UniswapV2: K')];
                    case 3:
                        _a.sent();
    ...
    it('swap:token0', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token0Amount, token1Amount, swapAmount, expectedOutputAmount, reserves, _a, _b, totalSupplyToken0, totalSupplyToken1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    token0Amount = (0, utilities_1.expandTo18Decimals)(5);
                    token1Amount = (0, utilities_1.expandTo18Decimals)(10);
                    return [4 /*yield*/, addLiquidity(token0Amount, token1Amount)];
                case 1:
                    _e.sent();
                    swapAmount = (0, utilities_1.expandTo18Decimals)(1);
                    expectedOutputAmount = (0, utils_1.bigNumberify)('1662497915624478906');
                    return [4 /*yield*/, token0.transfer(pair.address, swapAmount)];
                case 2:
                    _e.sent();
                    return [4 /*yield*/, (0, chai_1.expect)(pair.swap(0, expectedOutputAmount, wallet.address, '0x', overrides))
                ...
                case 4:
                    reserves = _e.sent();
                    (0, chai_1.expect)(reserves[0]).to.eq(token0Amount.add(swapAmount));
                    (0, chai_1.expect)(reserves[1]).to.eq(token1Amount.sub(expectedOutputAmount));
                    _a = chai_1.expect;
                    return [4 /*yield*/, token0.balanceOf(pair.address)];
                case 5:
    ...
    it('swap:token1', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token0Amount, token1Amount, swapAmount, expectedOutputAmount, reserves, _a, _b, totalSupplyToken0, totalSupplyToken1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 1:
                    _e.sent();
                    swapAmount = (0, utilities_1.expandTo18Decimals)(1);
                    expectedOutputAmount = (0, utils_1.bigNumberify)('453305446940074565');
                    return [4 /*yield*/, token1.transfer(pair.address, swapAmount)];
                case 2:
                    _e.sent();
                    return [4 /*yield*/, (0, chai_1.expect)(pair.swap(expectedOutputAmount, 0, wallet.address, '0x', overrides))
                ...
                case 4:
                    reserves = _e.sent();
                    (0, chai_1.expect)(reserves[0]).to.eq(token0Amount.sub(expectedOutputAmount));
                    (0, chai_1.expect)(reserves[1]).to.eq(token1Amount.add(swapAmount));
                    _a = chai_1.expect;
                    return [4 /*yield*/, token0.balanceOf(pair.address)];
                case 5:
    ...
    it('swap:gas', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 9:
                    receipt = _e.sent();
                    (0, chai_1.expect)(receipt.gasUsed).to.eq(73462);
                    return [2 /*return*/];
            }
        });
    }); });
    it('burn', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token0Amount, token1Amount, expectedLiquidity, _a, _b, _c, _d, totalSupplyToken0, totalSupplyToken1, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    token0Amount = (0, utilities_1.expandTo18Decimals)(3);
                    token1Amount = (0, utilities_1.expandTo18Decimals)(3);
                    return [4 /*yield*/, addLiquidity(token0Amount, token1Amount)];
                case 1:
                    _g.sent();
                    expectedLiquidity = (0, utilities_1.expandTo18Decimals)(3);
                    return [4 /*yield*/, pair.transfer(pair.address, expectedLiquidity.sub(MINIMUM_LIQUIDITY))];
                case 2:
                    _g.sent();
                    return [4 /*yield*/, (0, chai_1.expect)(pair.burn(wallet.address, overrides))
                            .to.emit(pair, 'Transfer')
    ...
    it('price{0,1}CumulativeLast', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, utilities_1.mineBlock)(provider, blockTimestamp + 1)];
                case 3:
                    _k.sent();
                    return [4 /*yield*/, pair.sync(overrides)];
                case 4:
                    _k.sent();
                    initialPrice = (0, utilities_1.encodePrice)(token0Amount, token1Amount);
                    _a = chai_1.expect;
                ...
                case 7:
                    ...
                    swapAmount = (0, utilities_1.expandTo18Decimals)(3);
                    return [4 /*yield*/, token0.transfer(pair.address, swapAmount)];
                case 8:
                    _k.sent();
                    return [4 /*yield*/, (0, utilities_1.mineBlock)(provider, blockTimestamp + 10)
                        // swap to a new price eagerly instead of syncing
                    ];
                case 9:
                    _k.sent();
                    // swap to a new price eagerly instead of syncing
                    return [4 /*yield*/, pair.swap(0, (0, utilities_1.expandTo18Decimals)(1), wallet.address, '0x', overrides)]; // make the price nice
                case 10:
                    // swap to a new price eagerly instead of syncing
                ...
                case 13:
                    ...
                    return [4 /*yield*/, (0, utilities_1.mineBlock)(provider, blockTimestamp + 20)];
                case 14:
                    _k.sent();
                    return [4 /*yield*/, pair.sync(overrides)];
                case 15:
                    _k.sent();
                    newPrice = (0, utilities_1.encodePrice)((0, utilities_1.expandTo18Decimals)(6), (0, utilities_1.expandTo18Decimals)(2));
                    _g = chai_1.expect;
                    return [4 /*yield*/, pair.price0CumulativeLast()];
                case 16:
    ...
    it('feeTo:off', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token0Amount, token1Amount, swapAmount, expectedOutputAmount, expectedLiquidity, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    token0Amount = (0, utilities_1.expandTo18Decimals)(1000);
                    token1Amount = (0, utilities_1.expandTo18Decimals)(1000);
                    return [4 /*yield*/, addLiquidity(token0Amount, token1Amount)];
                case 1:
                    _b.sent();
                    swapAmount = (0, utilities_1.expandTo18Decimals)(1);
                    expectedOutputAmount = (0, utils_1.bigNumberify)('996006981039903216');
                    return [4 /*yield*/, token1.transfer(pair.address, swapAmount)];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, pair.swap(expectedOutputAmount, 0, wallet.address, '0x', overrides)];
                case 3:
                    _b.sent();
                    expectedLiquidity = (0, utilities_1.expandTo18Decimals)(1000);
                    return [4 /*yield*/, pair.transfer(pair.address, expectedLiquidity.sub(MINIMUM_LIQUIDITY))];
                case 4:
                    _b.sent();
    ...
    it('feeTo:on', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 9:
                    // using 1000 here instead of the symbolic MINIMUM_LIQUIDITY because the amounts only happen to be equal...
                    // ...because the initial liquidity amounts were equal
                    _c.apply(void 0, [_e.sent()]).to.eq((0, utils_1.bigNumberify)(1000).add('249501683697445'));
                    _d = chai_1.expect;
                    return [4 /*yield*/, token1.balanceOf(pair.address)];
                case 10:
                    _d.apply(void 0, [_e.sent()]).to.eq((0, utils_1.bigNumberify)(1000).add('250000187312969'));
                    return [2 /*return*/];
            }
        });
    }); });
