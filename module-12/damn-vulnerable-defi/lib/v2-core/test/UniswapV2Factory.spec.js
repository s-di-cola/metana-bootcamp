...
describe('UniswapV2Factory', function () {
    ...
    var loadFixture = (0, ethereum_waffle_1.createFixtureLoader)(provider, [wallet, other]);
    var factory;
    ...
    it('feeTo, feeToSetter, allPairsLength', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b, _c;
    ...
    function createPair(tokens) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        bytecode = "0x".concat(UniswapV2Pair_json_1.default.evm.bytecode.object);
                    ...
                    case 1:
                        _h.sent();
                        return [4 /*yield*/, (0, chai_1.expect)(factory.createPair.apply(factory, tokens)).to.be.reverted]; // UniswapV2: PAIR_EXISTS
                    case 2:
                        _h.sent(); // UniswapV2: PAIR_EXISTS
                        return [4 /*yield*/, (0, chai_1.expect)(factory.createPair.apply(factory, tokens.slice().reverse())).to.be.reverted]; // UniswapV2: PAIR_EXISTS
                    case 3:
                        _h.sent(); // UniswapV2: PAIR_EXISTS
                        _a = chai_1.expect;
    ...
    it('createPair', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('createPair:reverse', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('createPair:gas', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tx, receipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    receipt = _a.sent();
                    (0, chai_1.expect)(receipt.gasUsed).to.eq(2512920);
                    return [2 /*return*/];
            }
        });
    }); });
    it('setFeeTo', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, chai_1.expect)(factory.connect(other).setFeeTo(other.address)).to.be.revertedWith('UniswapV2: FORBIDDEN')];
                case 1:
                    _b.sent();
    ...
    it('setFeeToSetter', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, chai_1.expect)(factory.connect(other).setFeeToSetter(other.address)).to.be.revertedWith('UniswapV2: FORBIDDEN')];
                case 1:
                    _b.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)(factory.setFeeToSetter(wallet.address)).to.be.revertedWith('UniswapV2: FORBIDDEN')];
                case 4:
                    _b.sent();
                    return [2 /*return*/];
            }
