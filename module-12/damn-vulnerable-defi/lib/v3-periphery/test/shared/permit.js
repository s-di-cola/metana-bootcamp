...
function getPermitSignature(wallet_1, token_1, spender_1) {
    return __awaiter(this, arguments, void 0, function (wallet, token, spender, value, deadline, permitConfig) {
        var _a, nonce, name, version, chainId, _b;
        var _c, _d, _e, _f;
        if (value === void 0) { value = ethers_1.constants.MaxUint256; }
        if (deadline === void 0) { deadline = ethers_1.constants.MaxUint256; }
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        (_c = permitConfig === null || permitConfig === void 0 ? void 0 : permitConfig.nonce) !== null && _c !== void 0 ? _c : token.nonces(wallet.address),
                        (_d = permitConfig === null || permitConfig === void 0 ? void 0 : permitConfig.name) !== null && _d !== void 0 ? _d : token.name(),
