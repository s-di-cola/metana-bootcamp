...
function createPool(nft, wallet, tokenAddressA, tokenAddressB) {
...
function createPoolWithMultiplePositions(nft, wallet, tokenAddressA, tokenAddressB) {
    return __awaiter(this, void 0, void 0, function () {
        var liquidityParams, liquidityParams2, liquidityParams3;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, nft.mint(liquidityParams)];
                case 2:
                    _b.sent();
                    liquidityParams2 = {
                        token0: tokenAddressA,
                    ...
                    return [4 /*yield*/, nft.mint(liquidityParams2)];
                case 3:
                    _b.sent();
                    liquidityParams3 = {
                        token0: tokenAddressA,
                    ...
                    return [2 /*return*/, nft.mint(liquidityParams3)];
            }
        });
    });
}
function createPoolWithZeroTickInitialized(nft, wallet, tokenAddressA, tokenAddressB) {
    return __awaiter(this, void 0, void 0, function () {
        var liquidityParams, liquidityParams2, liquidityParams3;
        var _a;
        return __generator(this, function (_b) {
