...
describe('UniswapV2Migrator', function () {
    ...
    it('migrate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, WETHPartner.approve(WETHExchangeV1.address, constants_1.MaxUint256)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, WETHExchangeV1.addLiquidity((0, utils_1.bigNumberify)(1), WETHPartnerAmount, constants_1.MaxUint256, __assign(__assign({}, overrides), { value: ETHAmount }))];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, WETHExchangeV1.approve(migrator.address, constants_1.MaxUint256)];
                case 3:
                    _b.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)(migrator.migrate(WETHPartner.address, WETHPartnerAmount, ETHAmount, wallet.address, constants_1.MaxUint256, overrides))
