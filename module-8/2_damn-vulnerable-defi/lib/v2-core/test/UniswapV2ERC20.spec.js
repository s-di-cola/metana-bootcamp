...
describe('UniswapV2ERC20', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(wallet, ERC20_json_1.default, [TOTAL_SUPPLY])];
                case 1:
                    token = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('name, symbol, decimals, totalSupply, balanceOf, DOMAIN_SEPARATOR, PERMIT_TYPEHASH', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    name = _g.sent();
                    (0, chai_1.expect)(name).to.eq('Uniswap V2');
                    _a = chai_1.expect;
                ...
                case 6:
                    _e.apply(void 0, [_g.sent()]).to.eq((0, utils_1.keccak256)(utils_1.defaultAbiCoder.encode(['bytes32', 'bytes32', 'bytes32', 'uint256', 'address'], [
                ...
                case 7:
                    _f.apply(void 0, [_g.sent()]).to.eq((0, utils_1.keccak256)((0, utils_1.toUtf8Bytes)('Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)')));
                    return [2 /*return*/];
            }
        });
    }); });
    it('approve', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, chai_1.expect)(token.approve(other.address, TEST_AMOUNT))
    ...
    it('transfer', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, chai_1.expect)(token.transfer(other.address, TEST_AMOUNT))
    ...
    it('transfer:fail', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, chai_1.expect)(token.transfer(other.address, TOTAL_SUPPLY.add(1))).to.be.reverted]; // ds-math-sub-underflow
                case 1:
                    _a.sent(); // ds-math-sub-underflow
                    return [4 /*yield*/, (0, chai_1.expect)(token.connect(other).transfer(wallet.address, 1)).to.be.reverted]; // ds-math-sub-underflow
                case 2:
                    _a.sent(); // ds-math-sub-underflow
                    return [2 /*return*/];
            }
    ...
    it('transferFrom', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.sent();
                    return [4 /*yield*/, (0, chai_1.expect)(token.connect(other).transferFrom(wallet.address, other.address, TEST_AMOUNT))
                            .to.emit(token, 'Transfer')
                            .withArgs(wallet.address, other.address, TEST_AMOUNT)];
                case 2:
                    _d.sent();
    ...
    it('transferFrom:max', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, utilities_1.getApprovalDigest)(token, { owner: wallet.address, spender: other.address, value: TEST_AMOUNT }, nonce, deadline)];
                case 2:
                    digest = _d.sent();
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)(token.permit(wallet.address, other.address, TEST_AMOUNT, deadline, v, (0, utils_1.hexlify)(r), (0, utils_1.hexlify)(s)))
                            .to.emit(token, 'Approval')
                            .withArgs(wallet.address, other.address, TEST_AMOUNT)];
                case 3:
                    _d.sent();
                ...
                case 5:
                    _c.apply(void 0, [_d.sent()]).to.eq((0, utils_1.bigNumberify)(1));
                    return [2 /*return*/];
            }
        });
    }); });
